...
#define DATA_PIN    25 // Kits shipped after March 1, 2019 should use 14. Earlier kits us 5.
...
#define BASE_URI "/cgi-bin/data/metar.php?format=xml&ids="
...
void loop() {
  ...
  if (WiFi.status() != WL_CONNECTED) {
    ...
    FastLED.show();
    WiFi.mode(WIFI_STA);
    WiFi.setHostname("LED Sectional");
